        ...
        <div class="bg-white/90 dark:bg-green-100/80 rounded-2xl shadow-2xl p-4 sm:p-8 border border-green-100 dark:border-green-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                <ul class="space-y-6 md:space-y-8">
                    <li>
                        <a href="{{ route('barangs.index') }}" class="flex items-center gap-3 px-5 py-4 rounded-xl bg-green-50 dark:bg-green-200 hover:bg-green-100 dark:hover:bg-green-300 text-green-700 dark:text-green-900 font-semibold shadow transition w-full">
                            ...
                            <span class="text-lg">Manajemen Stok Opname</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('goods-receipts.index') }}" class="flex items-center gap-3 px-5 py-4 rounded-xl bg-purple-50 dark:bg-purple-200 hover:bg-purple-100 dark:hover:bg-purple-300 text-purple-700 dark:text-purple-900 font-semibold shadow transition w-full">
                            ...
                            <span class="text-lg">Penerimaan Barang (GRN)</span>
                        </a>
                    </li>
                    <li>
                ...
                <div class="md:col-span-2 flex flex-col gap-8">
                    ...
                    <div class="overflow-x-auto rounded-xl bg-blue-50 dark:bg-blue-200 p-4 shadow">
                        <h2 class="text-lg font-bold mb-4 text-blue-700">Grafik Permintaan Pembelian (PR) per Bulan</h2>
                        <div class="w-full min-w-[320px] max-w-full">
            ...
            <script>
                ...
                // Data PR per bulan
                const prLabels = @json($prPerMonth->pluck('bulan')->map(fn($b)=>date('M Y', strtotime($b))));
